...
Cara Jalankan:
  python3 receiver.py --session nova_flight_1
  python3 receiver.py --session nova_flight_1 --img-port 5600 --od-port 5601
=============================================================================
"""
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="NOVA Receiver – Ground station image & OD receiver"
    )
...
def main():
    ...
    log.info("=" * 60)
    log.info("PROGRAM-NOVA Receiver v1.0")
